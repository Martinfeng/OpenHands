        ...
        <>
          ...
          <div className="flex flex-col gap-2.5">
            ...
            <textarea
              ...
              className="bg-tertiary border border-[#717888] rounded-sm p-2 text-sm font-mono text-foreground placeholder:text-[#717888] min-h-[60px] resize-y focus:outline-none focus:border-white"
              value={commandText}
