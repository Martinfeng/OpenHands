  ...
  return (
    <button
      ...
      className={cn(
        ...
        variant === "primary" &&
          "bg-primary text-[var(--oh-accent-foreground)] hover:opacity-90 disabled:bg-[var(--oh-interactive-hover)] disabled:text-[var(--oh-muted)] disabled:opacity-100",
        variant === "secondary" &&
          "border border-[var(--oh-border)] bg-base-secondary text-foreground hover:bg-surface-raised",
        variant === "tertiary" &&
          "bg-[var(--oh-interactive-hover)] text-foreground hover:opacity-80",
