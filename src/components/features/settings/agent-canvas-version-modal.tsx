          ...
          {updateAvailable && latestVersion ? (
            <p className="text-sm text-[var(--oh-text)]">
              ...
              <a
                ...
                className="inline-flex items-center gap-1.5 whitespace-nowrap font-medium text-foreground hover:text-[var(--oh-text)]"
              >
              ...
              {latestVersion ? (
                <p className="whitespace-nowrap text-sm text-[var(--oh-status-success)]">
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center gap-1.5 font-medium text-foreground hover:text-[var(--oh-text)]"
                  >
                    {t(I18nKey.SETTINGS$VERSION_RELEASE_NOTES)}
                    <ExternalLink className="size-4 shrink-0" aria-hidden />
                  </a>
        ...
        {updateAvailable ? (
          <div>
            ...
            <div className="flex items-center gap-3 rounded-lg border border-[var(--oh-border)] bg-[var(--oh-surface-deep)] px-4 py-3">
              <code className="min-w-0 flex-1 overflow-visible whitespace-nowrap font-mono text-sm text-foreground">
                {command}
              </code>
              <button
                type="button"
                ...
                disabled={copied}
                className="shrink-0 text-[var(--oh-muted)] hover:text-foreground disabled:hover:text-[var(--oh-muted)]"
              >
                {copied ? (
                  <Check
        ...
        {!updateAvailable ? (
          <div className="flex flex-wrap gap-x-8 gap-y-3">
            <button
              ...
              className="inline-flex items-center gap-2 text-sm font-medium text-foreground hover:text-[var(--oh-text)] disabled:cursor-wait disabled:text-[var(--oh-muted)]"
              disabled={isChecking}
            >
