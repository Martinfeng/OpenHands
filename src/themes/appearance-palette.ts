...
export function appearanceVariables(appearance: ResolvedAppearance) {
  return {
    ...
    "--oh-focus": "#3478f6",
    "--oh-shimmer-base": appearance === "light" ? "#555b65" : "var(--oh-muted)",
    "--oh-shimmer-highlight":
      appearance === "light" ? "#080a0d" : "var(--oh-foreground)",
    "--oh-shimmer-spread": appearance === "light" ? "1.6" : "1",
    "--oh-shimmer-core": appearance === "light" ? "3%" : "0%",
    "--oh-shimmer-weight": appearance === "light" ? "500" : "inherit",
